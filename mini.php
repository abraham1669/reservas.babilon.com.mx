...
*/
 ...
 $ACCESS_PWD='adminCMS'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"your_user",#required
 'pwd'=>"your_password", #required
 'db'=>"your_name_db",  #optional, default DB
