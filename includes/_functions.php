...
define('empresa', 'Babilon Travel');
define("telefono", "+529982331069"); // TELEFONO PARA TEXT RICH, LINK DE URL TELEFONO.
...
define("facebook", "http://www.facebook.com/Babilon-Travel-527901097711162/");
...
$logo = base_url . "img/touch-icon-ipad.png"; // URL Logotipo para el email Tamaño Maximo 200px Ancho / 50px de alto
...
function contacto(){
    ...
    if(isset($_POST['hotel'])){
        ...
        $datos["Fecha de llegada"] = $_POST['from'];
        $datos["Fecha de salida"] = $_POST['to'];
        $datos["Ubicación"] = $_POST['ubicacion'];
        $datos["Adultos"] = $_POST['adults'];
        $datos["Niños"] = $_POST['children'];
        $datos["No. de Cuartos"] = $_POST['rooms'];
        $datos["Tipo de Cuarto"] = $_POST['room'];
    }
    $espacio = '<br>';
    ...
    $de = $datos['Email'];
    $subjet = "Nueva Reservación - Reservas Babilón";
    $para = "abraham.opp@gmail.com";
...
function envio_email($para, $de, $subjet, $tipo, $titulo, $msg){
    ...
    $email->SMTPAuth   = true;    
    $email->Timeout       =   60;               
    $email->Host       = "pen.boxsecured.com"; 
    $email->Port       = 465;                    
    $email->Username   = "contacto@babilon.com.mx"; 
    $email->Password   = "Contacto.2019!";        
    $email->From = 'contacto@babilon.com.mx';
    ...
    $email->addBCC("abraham.opp@gmail.com");
    if(!$email->send()) {
